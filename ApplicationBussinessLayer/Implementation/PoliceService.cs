...
namespace ApplicationServiceLayer
{
    ...
    public class PoliceService : IPoliceService
    {
        ...
        public PoliceService(IParkingLotRepository parkingLotRepository, IMSMQService mSMQService)
        {
        ...
        public List<Parking> ParkVehicle(VehicleDetails vehicleDetails)
        {
            ...
            if (parking.Count != 0)
            {
                this.mSMQService.AddToQueue("Police Parked Vehicle Having Number " + parking[0].VehicleNumber + " At Time " + parking[0].EntryTime);
            }
        ...
        public List<Parking> UnParkVehicle(int slotId)
        {
            ...
            if (parking.Count != 0)
            {
                this.mSMQService.AddToQueue("Police Unparked Vehicle Having Number " + parking[0].VehicleNumber + " At Time " + parking[0].EntryTime + " And Customer Has To Pay Charges " + parking[0].ParkingCharge);
            }
